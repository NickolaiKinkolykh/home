...
Feature: Desktop Checkout for Guest User - Feature 1
  As a customer
  I want to be able proceed to checkout
  So that I can specify my delivery and payment details and place the order

  Scenario: Proceed to checkout, final review and place order as guest user - Scenario 1
    Given I open the "Initial home page"
    And I am an anonymous customer with clear cookies
